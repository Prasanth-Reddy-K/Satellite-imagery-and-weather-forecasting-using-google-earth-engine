...
with warnings.catch_warnings():
 ...
 with netcdf.netcdf_file('D:\miniproject2\compday.KsNOdsJTz1.nc', 'r') as f:
...
def mapping_map_to_sphere(lon, lat, radius=1):
 #this function maps the points of coords (lon, lat) to points onto the sphere of radius 
# radius
...
xs, ys, zs=mapping_map_to_sphere(lons, lats, radius=1.01)# here the radius is slightly 
#greater than 1 
...
noaxis=dict(showbackground=False,
 ...
 title='',
 zeroline=False)
layout3d=dict(title='Outgoing Longwave Radiation Anomalies<br>Dec 2022-Jan 2022',
